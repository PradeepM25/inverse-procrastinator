...
export const TaskModal = ({isOpen, onClose, taskToEdit, onSave, onLogout}) => {
    ...
    const handleSubmit = useCallback(async (e) => {
        ...
        if(taskData.dueDate < today) {
            setError("Due date can't be in past");
            return;
        }
        setLoading(loading);
        setError(null);
        try {
            ...
            console.error(err.message || "An unexpected error")
        } finally {
            setLoading(false);
        }
    ...
    <div className='fixed inset-0 backdrop-blur-sm bg-black/20 z-50 flex items-center justify-center p-4'>
      <div className='bg-white border border-purple-100 rounded-xl max-w-md w-full shadow-lg relative p-6 animate-fadeIn'>
        <div className='flex justify-between items-center mb-6'>
            ...
            <button onClick={onClose} className='p-2 hover:bg-purple-100 rounded-lg transition-colors text-gray-500 
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
            ...
            <div>
                ...
                <div className='flex items-center border border-purple-100 rounded-lg px-3 py-2.5 focus-within:ring-2
                focus-within:ring-purple-500 focus-within:border-purple-500 transition-all duration-200'>
            ...
            <div>
                ...
                className={baseControlClasses} placeholder='Add description about your task' />
            </div>
            ...
            <button type='submit' disabled={loading} className='w-full bg-gradient-to-r from-fuchsia-500 to-purple-600
            text-white font-medium px-4 py-2.5 rounded-lg flex items-center justify-center gap-2 disabled:opacity-50
